        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorDtoId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_Doctors_DoctorDtoId",
                        column: x => x.DoctorDtoId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bookings_Patients_PatientDtoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_DoctorDtoId",
                table: "Bookings",
                column: "DoctorDtoId");

            migrationBuilder.CreateIndex(
                name: "IX_Bookings_PatientDtoId",
                table: "Bookings",
                column: "PatientDtoId");
        }
